...
var forms = function forms() {
  ...
  form.forEach(function (item) {
    ...
    item.addEventListener('submit', function (e) {
      ...
      postData(api, formData) //! then and catch почитать! Промисы положительно ли выполнен запрос или отрицательно 
      .then(function (res) {
        console.log(res);
...
var showMoreStyles = function showMoreStyles(trigger, styles) {
  ...
  var cards = document.querySelectorAll(styles),
      btn = document.querySelector(trigger); //! Перебираем массив карточек
